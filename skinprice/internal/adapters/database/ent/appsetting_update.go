...
func (_u *AppSettingUpdate) SetNillableUpdatedAt(v *time.Time) *AppSettingUpdate {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
func (_u *AppSettingUpdate) ClearUpdatedAt() *AppSettingUpdate {
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_u *AppSettingUpdateOne) SetNillableUpdatedAt(v *time.Time) *AppSettingUpdateOne {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
// ClearUpdatedAt clears the value of the "updated_at" field.
func (_u *AppSettingUpdateOne) ClearUpdatedAt() *AppSettingUpdateOne {
	_u.mutation.ClearUpdatedAt()
	return _u
}
